...
import { getGeminiClient, OPPORTUNITY_EXPLANATION_MODEL } from "@/lib/ai/client";
import { OpportunityNarrativeSchema, type OpportunityNarrative } from "@/lib/ai/schemas";
import { formatInr, type AbandonedCheckoutResult } from "@/lib/services/opportunity-engine";
